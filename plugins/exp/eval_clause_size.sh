...
out_file2="$res_dir/barplot_clause_size.pdf"
...
ls_inst_artefacts "$res_dir" "$OUT_INST_CLAUSE_SIZE_NORMALIZED" |xargs -I {} cat {} |awk '{
...
datarow_1="$res_dir/gmean_normalized_reports_per_claussize.tmp"
datarow_2="$res_dir/gmean_dcpr_per_claussize.tmp"
awk '{print $1, 100*$2}' $out_file1 > $datarow_1
awk '{print $1, 100*$3}' $out_file1 > $datarow_2
python3 ../python/barplot.py -o=$out_file2 --ylabel="\$\#\$ clause productions [$\%$]" --xlabel="clause size \$l\$" --ymin="0" \
